...
void Graphics::draw_text(const std::string& text, int pos_x, int pos_y)
{
...
void Graphics::draw_text_to_pixel(const std::string& text, int pos_x, int pos_y)
{
	SDL_Color col{ 255, 255, 255, 255 };
...
void Graphics::set_title(const std::string& input)
{
